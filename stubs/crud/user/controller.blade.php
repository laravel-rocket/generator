...
use App\Http\Requests\User\{{  $modelName }}Request;
    ...
    */
    public function index(PaginationRequest $request)
    {
        ...
        return view('pages.admin.<% kebab_case($models) %>.index', [
            ...
            'offset'  => $offset,
            'limit'   => $limit,
            'baseUrl' => action('User\{{  $modelName }}Controller@index'),
        ]);
    }
...
@endif
        ...
        return redirect()->action('User\{{  $modelName }}Controller@index')
    ...
    */
    ...
    {
        return redirect()->action('User\{{  $modelName }}Controller@@show', [$id]);
    }
