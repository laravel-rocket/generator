 ...
 * ＠method \App\Models\{{ $modelName }}[]|\Traversable|array get($order, $direction, $offset, $limit, $before = 0)
 ...
 * ＠method \App\Models\{{ $modelName }}[]|\Traversable|array getByFilter($filter,$order = null, $direction = null, $offset = null, $limit = null, $before = 0);
